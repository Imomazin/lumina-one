        ...
        <nav className="flex-1 p-4 space-y-6 overflow-y-auto">
          ...
          <div className="space-y-1">
            ...
            {modules.map((module) => {
              ...
              if (module.externalUrl) {
                return (
                  <a
                    ...
                    className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
                  >
              ...
              // Otherwise render as internal NavLink
              return (
                <NavLink
                  key={module.id}
                  to={module.baseRoute}
